...
<html lang="vi">
    <head>
        ...
        <title>Hiep MP3 | Nghe Nhạc Online</title>
        <meta charset="UTF-8">
    ...
    <body>
    <header>
        <nav class="navbar navbar-expand-sm navbar-dark" style="background: #007bff;">
            <div class="res-navbar row" style="margin-left: 120px;">
                <div class="row" >
                ...
                <div class="collapse navbar-collapse col-sm-11 col-lg-11" id="nav-content">   
                    <ul class="navbar-nav row" >
                        <div class="items-navbar d-none d-sm-block col-sm-6 col-lg-4" style="left: 690px;">
                        ...
                        <div class="khung-tim-kiem col-12 col-sm-5 col-md-3 col-lg-3 col-xl-2">
                            <form class="form-inline" action="#" method="post" autocomplete="on">
                                <input name="search" id="search" class="form-control mr-sm-2" type="text" placeholder="Nhập nội dung cần tìm...">
                            </form>
