    ...
    <script src="public/js/ajax_kiem_tra_trung/xl_email.js"></script>
        <div class="container" id="container" style="margin-left: 495px; margin-top: 30px">
            <div class="row" >
                <div class="col-sm-4 col-sm-offset-4">
                    <form action="dang_ky.php" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <button type="submit" name="btn_dang_ky" class="btn btn-success" style="margin-left: 130px;">Đăng ký</button>
                    </form>
                </div>
            </div>
        </div>
