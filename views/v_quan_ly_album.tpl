        ...
        <h2 class="w3-text-teal h2">Quản lý bài hát</h2>
            <table class="w3-table-all" id="table_loai_sua">
                ...
                {/foreach}
                    ...
                    <div id ="tb">(Vì số lượng Album chỉ hiển thị được tối đa là 4, nên khi muốn hiển thị Album khác vui lòng xóa Album cũ và duyệt Album mới!)
                    <br><br> *Tính năng còn đang được phát triển
                    </div>
	</div>
</div>